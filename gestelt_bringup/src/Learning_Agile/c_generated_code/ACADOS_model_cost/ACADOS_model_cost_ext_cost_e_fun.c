...
/* ACADOS_model_cost_ext_cost_e_fun:(i0[10],i1[],i2[],i3[30])->(o0) */
...
CASADI_SYMBOL_EXPORT int ACADOS_model_cost_ext_cost_e_fun_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
