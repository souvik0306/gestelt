...
def plot_comparison(bag_path):
    ...
    if position and len(position['time']) > 0:
        ...
        ax9_x.set_title(f'Local Position (First {TIME_WINDOW}s)', fontsize=14, fontweight='bold')
        ax9_x.set_xlim([0, TIME_WINDOW])
